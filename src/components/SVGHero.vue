<template>
  ...
  >
    ...
    <g id="arrière_plan">
      ...
      />
      <ellipse id="Soleil" class="cls-2" cx="742.02" cy="756.66" rx="232.99" ry="218.1" />
      <path
        id="cloud-5"
        class="cls-4"
...
#cloud-1{
  animation: cloudAnim 26s ease-in-out infinite;
}

#cloud-2{
  animation: cloudAnim2 20s ease-in-out infinite;
}

#cloud-3{
  animation: cloudAnim 15s ease-in-out infinite;
}

#cloud-4{
  animation: cloudAnim2 18s ease-in-out infinite;
}

#cloud-5{
  animation: cloudAnim 24s ease-in-out infinite;
}
